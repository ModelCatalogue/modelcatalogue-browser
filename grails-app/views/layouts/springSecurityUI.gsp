<%@ page import="org.codehaus.groovy.grails.plugins.PluginManagerHolder; grails.plugins.springsecurity.SecurityConfigType; org.codehaus.groovy.grails.plugins.springsecurity.SpringSecurityUtils" %>
