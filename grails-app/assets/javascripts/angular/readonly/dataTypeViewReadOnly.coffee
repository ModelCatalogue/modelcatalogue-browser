angular.module('mc.core.ui.dataTypeViewReadOnly', ['mc.core.catalogueElementEnhancer', 'mc.core.listReferenceEnhancer', 'mc.core.listEnhancer', 'mc.util.names', 'mc.util.messages', 'mc.core.ui.columns', 'ui.router']).directive 'datatypeViewReadOnly',  [-> {
restrict: 'E'
replace: true
scope:
  element: '='
