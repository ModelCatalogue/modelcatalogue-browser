angular.module('mc.core.ui.modelViewReadOnly', ['mc.core.catalogueElementEnhancer', 'mc.core.listReferenceEnhancer', 'mc.core.listEnhancer', 'mc.util.names', 'mc.util.messages', 'mc.core.ui.columns', 'ui.router']).directive 'modelViewReadOnly',  [-> {
restrict: 'E'
replace: true
scope:
  element: '='
...
templateUrl: 'modelcatalogue/core/ui/modelViewReadOnly.html'


controller: ['$scope', '$log', '$filter', '$q', '$state', 'enhance', 'names', 'columns', 'messages', '$rootScope','modelCatalogueApiRoot' , ($scope, $log, $filter, $q, $state, enhance, names, columns, messages, $rootScope,modelCatalogueApiRoot) ->
  ...
  onElementUpdate = (element) ->
    ...
    for name, fn of element when enhance.isEnhancedBy(fn, 'listReference')
      ...
      removeHeaders = ["History","Superseded By","Supersedes","Relationships","History"]
