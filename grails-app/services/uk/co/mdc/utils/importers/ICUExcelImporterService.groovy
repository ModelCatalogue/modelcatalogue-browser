...
class ICUExcelImporterService {
    ...
    private grantUserPermissions(objectOrList) {
        ...
        if (objectOrList instanceof java.util.Collection) {
            ...
            aclUtilService.addPermission objectOrList, 'ROLE_READONLY_ADMIN', BasePermission.ADMINISTRATION
            aclUtilService.addPermission objectOrList, 'ROLE_READONLY_USER', BasePermission.READ
        }
    }
